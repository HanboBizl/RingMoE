...
from register import RingMoEConfig
...
from ringmoe_framework.tools.helper import str2bool, build_context

ac.obs_register(ak='HC4OBVO4QIJ1BHBSE7QX',
                sk='E89SYVtEpEUv7X7iAeNkNnMBmUovDHJmy8M18pIe',
                server='https://obs.cn-southwest-228.cdzs.cn')
