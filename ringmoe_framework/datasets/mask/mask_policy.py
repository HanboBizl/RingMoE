...
# ============================================================================
"""mask policy of ringmo_framework"""
import numpy as np
...
# @RingMoEClassFactory.register(RingMoEModule.DATASET_MASK)
...
class MaskPolicyForRingMoMM(py_transforms.PyTensorOperation):
    """Mask generator for ringmo_framework multi-modal arch."""

    def __init__(self, input_size=224, patch_size=4, mask_ratio=0.75):
        super(MaskPolicyForRingMoMM, self).__init__()
